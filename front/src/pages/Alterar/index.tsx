...
const Editar: React.FC = () => {
  ...
  const load = async () => {
    ...
    await api
      ...
      .then(({ data }) => {
        setPpp(data)
        setSelectedMedico(data.medico_id)
        setSelectedFuncionario(data.funcionario_id)
        setSelectedExame(data.exame_id)
        setSelectedAgente(data.agente_id)
      })
    ...
    async function handleSubmit(data: Ppp) {
      ...
      return(
          ...
          
        {
          ...
          <br></br>
         <Input name="descricao" defaultValue={ppp?.descricao} placeholder="Descricao" />
